...
export const Signin = ()=>{
    const [postInputs,setPostInput] = useState<SigninInputs>({
        email:"",
        password:"",
    })
    ...
    async function sendRequest(){
        try{
            const response = await axios.post(`${BACKEND_URL_LOCAL}/user/signin`,
               postInputs
            )
    ...
    return (
        <div className="px-20 py-10 h-screen lg:flex justify-center items-center gap-x-40 bg-slate-200 font-sans	">
            <div className="bg-slate-100 px-5 py-10 rounded lg:w-1/4 text-center shadow-lg h-4/5">
                ...
                <p className="mb-10 italic">Don't have an account <a href="/signup" className="font-bold text-blue-600">Signup</a></p>
